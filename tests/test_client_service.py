...
class TestClientService:
    ...
    def test_create_client_with_encrypted_identifier(self, test_session):
        ...
        client_data = ClientCreate(
            name="Test Client", identifier="secret-id-123")
    ...
    def test_get_client_by_identifier_multiple_clients(self, test_session, test_data_factory):
        ...
        client1 = test_data_factory.create_client(
            test_session, identifier="id-1")
        client2 = test_data_factory.create_client(
            test_session, identifier="id-2")
        client3 = test_data_factory.create_client(
            test_session, identifier="id-3")
    ...
    def test_get_clients_last_page_shorter_than_limit(
        self, test_session, test_data_factory
    ):
        """Last page shorter than limit ⇒ frontend hasMore=False."""
        service = ClientService(test_session)
        ...
        page = service.get_clients(skip=10, limit=100)
    ...
    def test_get_clients_with_no_external_id(self, test_session, test_data_factory):
        ...
        # Create clients
        client1 = test_data_factory.create_client(
            test_session, name="Client 1")
        client2 = test_data_factory.create_client(
            test_session, name="Client 2")
        client3 = test_data_factory.create_client(
            test_session, name="Client 3")
    ...
    def test_add_external_id_multiple_systems(self, test_session, test_data_factory):
        ...
        holded_data = ClientExternalIdCreate(
            system="holded", external_id="holded-123")
        holded_result = service.add_external_id(created_client.id, holded_data)

        # Add external ID for fourgeeks
        fourgeeks_data = ClientExternalIdCreate(
            system="fourgeeks", external_id="4g-456")
        fourgeeks_result = service.add_external_id(
            created_client.id, fourgeeks_data)
    ...
    def test_get_client_by_external_id_success(self, test_session, test_data_factory):
        ...
        # Add external ID
        external_id_data = ClientExternalIdCreate(
            system="holded", external_id="ext-123")
    ...
    def test_get_client_external_id_success(self, test_session, test_data_factory):
        ...
        external_id_data = ClientExternalIdCreate(
            system="holded", external_id="ext-123")
        added_external_id = service.add_external_id(
            created_client.id, external_id_data)
    ...
    def test_client_service_database_error_handling(self, test_session):
        ...
        with patch.object(test_session, 'commit', side_effect=Exception("Database error")):
            client_data = ClientCreate(
                name="Test Client", identifier="test-id")
