...
def upgrade() -> None:
    ...
    op.create_foreign_key('invoice_service_contract_id_fkey',
                          'invoice', 'servicecontract', ['service_contract_id'], ['id'])
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint('invoice_service_contract_id_fkey',
